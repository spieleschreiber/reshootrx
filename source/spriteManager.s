...
;   #MARK: sprite player code
    ...
    ;move.w  #$a0,d4
    move.w      plyPosY(a1),d2      ;   y-position
    ;move.w  #$90,d2
    ;TOSHELL d4,"plyPosYABS"
    ...
    lea spritePlayerBasic+playerSprite1Offset(d6),a6    ; set pointer to anim frame
    move.w d2,0(a0)      ; SPRxPOS
    move.w d5,8(a0)     ; SPRxCTL
    move.w d2,0(a6)      ; SPRxPOS
    move.w d5,8(a6)     ; SPRxCTL

    lea         copSprite01,a5              ; write dma pointers to coplist
    move.l      a0,d0
    move.l      a6,d1
    move        d0,6(a5)
    swap        d0
    ...
    ;move.w  #$a0,d4
    move.w      plyPosY(a1),d2      ;   y-position
    add.w	 #playerContainerHeight+5,d2
    ;TOSHELL d4,"plyPosYABS"
    add         #displayWindowStart+4,d2
    moveq       #playerBodyHeight-1,d5
    add.w       d2,d5
    clr.b       d3
    lsl.w       #8,d2                   ; move vertical start bit 8 in place
    addx.b      d3,d3
    ...
    bset        #7,d6                   ; attach bit
    or          d6,d5
	lea	 (playerContainerHeight+1)*16(a0),a0
	lea	 (playerContainerHeight+1)*16(a6),a6
    move.w d2,0(a0)      ; SPRxPOS
    move.w d5,8(a0)     ; SPRxCTL
    move.w d2,0(a6)      ; SPRxPOS
    move.w d5,8(a6)     ; SPRxCTL
    ...
    ;move.w  #$a0,d4
    move.w      plyPosY(a1),d2      ;   y-position
	add.w	 #playerBodyHeight+playerContainerHeight+6,d2
    ;move.w  #$90,d2
    ;TOSHELL d4,"plyPosYABS"
    add         #displayWindowStart+4,d2
    moveq       #playerContainerHeight,d5
