...
viewPosition
	...
	; #MARK:  - TILE STORAGE
tileDefs
tilemapConvertedSize			
	dc.w	0
tilemapBckConvertedSize			
	dc.w	0
tilemapHeight					
	dc.w	0
tileMapWidth					
...
mainPlanes					
	dc.l		0,0,0,0			; offset needed for memory restore in _exit
mainPlanesPointer				
	blk.l		3,0				; pointer to mainPlanes plus current y-offset, three buffers
mainPlanesPointerAsync			
	dc.l		0,0
mainPlaneOneSize				
	dc.l		0
mainPlaneAllSize				
...
copperGameNext					
	dc.l		0
copperDialogueColors			
	dc.l		0
copInitColorswitch				
	dc.l		0				; filled in runtime -> points to end of game copperlist
diskBuffer						
	dc.l		0,0
diskBufferSize					
	dc.l		0
...
audioFXBaddie					
	dc.l		0
musicMemory						
	dc.l		0				; total music memory
musicTrackB						
	dc.l		0				; pointer to Track B
